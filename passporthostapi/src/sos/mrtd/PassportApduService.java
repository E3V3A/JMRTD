...
//                (byte) 0x01);
     ...
     * (first 8 bytes), <code>rndIFD</code> (next 8 bytes), their key material "<code>kICC</code>"
     * (last 16 bytes).
     * 
     * @param rndIFD
     *            our challenge
     ...
     *         by the passport, decrypted (using <code>kEnc</code>) and
     *         verified (using <code>kMac</code>)
     */
